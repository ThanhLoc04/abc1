...
var time= moment.tz("Asia/Ho_Chi_Minh").format("DD/MM/YYYY || HH:mm:s");
    ...
    return console.log(chalk.hex("#054BF8")(`◆━━━━━━━━━━◆━━━━━━━━━◆◆━━━━━━━━◆━━━━━━━━━━◆\nNhóm: ${threadName}`) + chalk.hex("#B980F1")(``) +chalk.hex("#B980F1") (`\nTên: ${name}`) + chalk.hex("#B980F1")(``) + chalk.hex("#054BF8")(`\nText: ${msg} `) + chalk.hex("#B980F1") (``) + chalk.hex("#B980F1")(`\n[ ${textt} ${time} ]`) );
}
}
