...
module.exports.run = async function({ api, event }) {
	...
	if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
        ...
        await api.sendMessage("〖 This is Warthog-12S1 Zygardion Attraqtia... 〗", event.threadID);
        await new Promise(resolve => setTimeout(resolve, 2000));
        await api.sendMessage("〖 Warthog-12S1 - Developed by Heo Rừng... 〗", event.threadID);
        await new Promise(resolve => setTimeout(resolve, 2000));
        await api.sendMessage("〖 Project Miraiv2... 〗", event.threadID);
        await new Promise(resolve => setTimeout(resolve, 2000));
...
///api.shareContact('',4,event.threadID)